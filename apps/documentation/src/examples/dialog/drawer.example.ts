...
@Component({
  imports: [MgnpButton, MgnpDialog, MgnpDialogDescription, MgnpDialogOverlay, MgnpDialogTitle, MgnpDialogTrigger],
  template: `
    <button mgnpButton [mgnpDialogTrigger]="drawer">Launch Drawer</button>

    <ng-template #drawer let-close="close">
      <div mgnpDialogOverlay mode="drawer">
        <div mgnpDialog>
