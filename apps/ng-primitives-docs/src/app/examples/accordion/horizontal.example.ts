...
@Component({
  ...
  template: `
    <div ngpAccordion ngpAccordionType="single" ngpAccordionOrientation="horizontal" ngpAccordionCollapsible mgnpAccordion>
...
export default class HorizontalExample {}
